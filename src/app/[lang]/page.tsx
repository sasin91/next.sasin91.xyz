...
import { appDomain, cloudinaryAppLogo } from '~/config';
import cld from '~/lib/cloudinary';

import { Button } from '~/components/ui/button';

function AppHeader({ lang }: { lang: Lng }) {
...
function HeroSection({ lang }: { lang: Lng }) {
...
function TimelineSection({ lang }: { lang: Lng }) {
  const { t } = useTranslation(lang);
